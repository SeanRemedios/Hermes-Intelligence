(function(context) {
  ...
  function App(localStorageKey) {
    this.$insert1 = $('#js-insert1');
    this.$insert2 = $('#js-insert2');
    this.$insert3 = $('#js-insert3');
  ...
  App.prototype.addEventListeners = function() {
    // $.on(this.$insert1, 'keypress', this.focusNext.bind(this));
    // $.on(this.$insert2, 'keypress', this.focusNext.bind(this));
    $.on(this.$insert3, 'keypress', this.onInsert.bind(this));
  ...
  App.prototype.onInsert = function(event) {
    ...
    var text1 = this.$insert1.value.trim();
    var text2 = this.$insert2.value.trim();
    var text3 = element.value.trim();

    if (text1 && text2 && text3 && event.keyCode === ENTER_KEY) {
      var text = {
        phone: text1,
        fromAddress: text2,
        toAddress: text3
  ...
  App.prototype.insert = function(text) {
    ...
    lib(GLOBALS.SERVICE_PATH + '.create')(
    // lib.seanr['todo-mongo']['@dev'].create(
    // lib.steve['todo-mongo']['@dev'].create(
      ...
      function(error, id) {
        ...
        item.id = id;
        item.text = item.text.phone + " " + item.text.fromAddress + " " + item.text.toAddress;
